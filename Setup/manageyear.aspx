<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="manageyear.aspx.cs" Inherits="Setup_manageyear" %>
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="#">Manage year</a></li>
            <li class="breadcrumb-item active">year Add</li>
          </ol>
        </div>
      </div>
    </div>
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <label for="inputName">Year</label>
                   <asp:TextBox ID="txt_year" runat="server" class="form-control" AutoComplete="off"></asp:TextBox>
                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender23" runat="server" Enabled="True" TargetControlID="txt_year" FilterType="Custom"
